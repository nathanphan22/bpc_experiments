...
def retrieve_data(scene,camera,image):
    camera_json_path = "/home/rama/dataset/ipd/train_pbr/" + scene + "/scene_camera_cam" + camera + ".json"
    object_json_path = "/home/rama/dataset/ipd/train_pbr/" + scene + "/scene_gt_cam" + camera + ".json"
...
def make_one_image_contours(scene,camera,image):
    ratio = 8
...
def main():
    ...
    for cam in range(1,4):
        ...
        for im in range(100):
            ...
            image_object_contours_list, image_object_id_list = make_one_image_contours(scene,str(camera),str(int(image)))
